...
import com.bitfolium.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
        ...
        usersClient.getProfile(cachedUserProfile!!.getId()!!)
                .start(object : Callback<UserProfile, ManagementException> {
                    ...
                    override fun onSuccess(result: UserProfile) {
                        ...
                        val location = result.getUserMetadata()["location"] as String?
                        binding.inputEditMetadata.setText(location)
                    }
                })
    }
    ...
    private fun patchUserMetadata() {
        val usersClient = UsersAPIClient(account, cachedCredentials!!.accessToken)
        val metadata = mapOf("location" to binding.inputEditMetadata.text.toString())
        usersClient
